...
oc create secret generic beaker --from-file images/provisioner/secrets/beaker/beaker.conf --from-file images/provisioner/secrets/beaker/id_rsa --from-file images/provisioner/secrets/beaker/RedHatInternalCA.pem
